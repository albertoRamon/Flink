...
//import org.apache.flink.api.table.Row (TIP: OLD Package)
import org.apache.flink.api.java.typeutils.RowTypeInfo
//import org.apache.flink.api.table.typeutils.RowTypeInfo (TIP: OLD Package)
...
object WordCount {
  def main(args: Array[String]) {
    ...
    //val DB_ROWTYPE = new RowTypeInfo(Seq(longColum))    (TIP: OLD Package)
